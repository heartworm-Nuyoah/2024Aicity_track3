...
def parse_args():
    ...
    parser.add_argument('--config',default='/disk2/js_data/AICITY/2023code/mmaction2-master/configs/Aicity/swin_base_patch244_window877_kinetics400_1k_dash_minidata.py', help='train config file path')
    parser.add_argument('--work-dir', default='/disk2/js_data/AICITY/2023code/mmaction2-master/runs/minidata_debug', help='the dir to save logs and models')
    parser.add_argument(
