...
def parse_args():
    ...
    parser.add_argument('--config',default='/disk2/js_data/AICITY/2023code/mmaction2-master/configs/Aicity/swin_base_patch244_window877_kinetics400_1k_rear_nobackground.py', help='test config file path')
    parser.add_argument('--checkpoint', default='/disk2/js_data/AICITY/2023code/mmaction2-master/runs/228_rear_nobackground/epoch_9.pth', help='checkpoint file')
    parser.add_argument(
        '--out',
        default=None,
