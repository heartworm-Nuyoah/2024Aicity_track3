...
# ann_file_train = '/disk2/js_data/AICITY/datasets/2023/AI-City-Challenge-2023/annotation/right_01_anno_train.txt'
# ann_file_val = '/disk2/js_data/AICITY/datasets/2023/AI-City-Challenge-2023/annotation/right_01_anno_val.txt'
...
ann_file_train = '/disk1/xyh/AICITY/datasets/data/labels/rear_anno_train1.txt'
ann_file_val = '/disk1/xyh/AICITY/datasets/data/labels/rear_anno_val1.txt'
ann_file_test = '/disk1/xyh/AICITY/datasets/data/labels/rear_anno_val1.txt'
img_norm_cfg = dict(
...
load_from = '/disk1/xyh/AICITY/2024code/mmaction2-master/work_dir/x3d_train/total/epoch_10.pth'
