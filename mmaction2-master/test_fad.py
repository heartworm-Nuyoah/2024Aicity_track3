...
def parse_args():
    ...
    parser.add_argument('--config', default='/disk2/js_data/AICITY/2023code/mmaction2-master/configs/Aicity/swin_base_patch244_window877_kinetics400_1k_dash_prob.py', help='test config file path')
    parser.add_argument('--checkpoint', default='/disk2/js_data/AICITY/2023code/mmaction2-master/runs/228_dash——prob/epoch_10.pth',help='checkpoint file')
    parser.add_argument(
        '--out',
        default='./debug/debug.pkl',
