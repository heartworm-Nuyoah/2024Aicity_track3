...
def parse_args():
    ...
    parser.add_argument('--config', default='/disk2/js_data/AICITY/2023code/mmaction2-master/runs/228_rear_nobackground/swin_base_patch244_window877_kinetics400_1k_rear_nobackground.py',help='test config file path')
    
    parser.add_argument('--checkpoint',default='/disk2/js_data/AICITY/2023code/mmaction2-master/runs/228_rear_nobackground/best_top1_acc_epoch_1.pth', help='checkpoint file/url')
    ...
    parser.add_argument('--video_data_root',default='/disk2/js_data/AICITY/datasets/2023/AI-City-Challenge-2023/A2_frame/Dashboard_user_id_96715_NoAudio_5', help='data_root directory')
    parser.add_argument('--label',default='/disk2/js_data/AICITY/2023code/mmaction2-master/label_map.txt', help='label file')
    parser.add_argument('--result_root',default='/disk2/js_data/AICITY/2023code/mmaction2-master/submit_results_source/test_1',help='result_root')
    parser.add_argument(
        '--cfg-options',
        nargs='+',
        action=DictAction,
    ...
    parser.add_argument('--view', default='right', type=str, help='view of dash, rear, right')
...
def main():
    ...
    if os.path.split(args.video_data_root)[1].lower().startswith(('dash','rear','right')):
        ...
        mkdir('/disk2/js_data/AICITY/2023code/mmaction2-master/submit_results_source')
        result_root = os.path.join('/disk2/js_data/AICITY/2023code/mmaction2-master/submit_results_source',
